...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if viewedTutorial{
            ...
            initialViewController = storyboard.instantiateViewControllerWithIdentifier("tutorialVC") as! IntroViewController
        }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "NelsonJE.Remember" in the application's documents Application Support directory.
